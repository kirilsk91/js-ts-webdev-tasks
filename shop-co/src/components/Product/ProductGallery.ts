...
export const ProductGallery = (product: Product): HTMLElement => {
  ...
  productGallery.className = 'product-gallery d-flex col-6';

  productGallery.innerHTML =
    /*html*/
    `
  <div class='product-gallery-items col-3'>
  </div>
  <div class='product-gallery-pic col-8'></div>
  `;
  ...
  galleryPicContainer.innerHTML = /*html*/ `<img src='${images[0]}'/>`;
